...
public class ShopWorkflowTest {
	...
	public void billingAndDeliveryAddress() {
		Assert.assertEquals(summary.getCartSummBillingAdressName().getText(), "testt tesetse");
		Assert.assertEquals(summary.getCartSummBillingAdressOne().getText(), "tt");
		Assert.assertEquals(summary.getCartSummBillingAdressCityState().getText(), "sg, vbgn 1212");
		Assert.assertEquals(summary.getCartSummBillingAdressCountry().getText(), "United States");
		Assert.assertEquals(summary.getCartSummBillingAdressHomePhone().getText(), "088");
